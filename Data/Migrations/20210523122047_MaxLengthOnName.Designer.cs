...
namespace pfe.Data.Migrations
{
    ...
    [Migration("20210523122047_MaxLengthOnName")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnseignantStage", b =>
                {
                    b.Property<int>("EncadrantInterneEnseignantId")
                        .HasColumnType("int");

                    b.Property<int>("StagesStageId")
                        .HasColumnType("int");

                    b.HasKey("EncadrantInterneEnseignantId", "StagesStageId");
            ...
            modelBuilder.Entity("EnseignantStage", b =>
                {
                    b.HasOne("pfe.Models.Enseignant", null)
                        .WithMany()
                        .HasForeignKey("EncadrantInterneEnseignantId")
